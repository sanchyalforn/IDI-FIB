...
void MyGLWidget::iniEscena ()
{
  ...
  glm::vec3 puntMax = glm::vec3(2.0,2.0,2.0);
  glm::vec3 centreEscena = (puntMax + puntMinim)/2.0f;
  radiEsc = glm::distance (centreEscena,puntMax);  
}
...
void MyGLWidget::carregaShaders()
{
  ...
  llumX = glGetUniformLocation (program->programId(), "llumX");
...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG = glm::translate(TG, glm::vec3(posX,-0.5,0));
...
void MyGLWidget::modelTransformPatricio2 () {
    ...
    TG = glm::rotate (TG, -(float)M_PI/2, glm::vec3(0,1,0));
    TG = glm::scale(TG, glm::vec3(escala*2.5, escala*2.5, escala*2.5));
    TG = glm::translate(TG, -centrePatr);
